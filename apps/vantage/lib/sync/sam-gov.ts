...
/**
 * TODO(schema): swap the return type for `Prisma.OpportunityCreateInput` once
 * apps/vantage/prisma/schema.prisma lands; field names were chosen to match
 * that spec ahead of time.
 */
