...
describe("mapAwardToCompetitorActivity", () => {
  it("maps a DoD award fixture to the internal row shape", () => {
    ...
    expect(row).toEqual({
      ...
      competitorName: "ACME FEDERAL SOLUTIONS LLC",
      awardAmount: 4823110.5,
      awardDate: new Date("2026-08-04"),
      agency: "Department of Defense",
      naicsCode: "541511",
      contractDescription: "ENTERPRISE IT SUPPORT AND HELP DESK SERVICES",
    });
  });
  ...
  it("maps a GSA award fixture correctly", () => {
    ...
    expect(row.agency).toBe("General Services Administration");
