...
/**
 * TODO(schema): swap the return type for the real CompetitorActivity
 * create-input once apps/vantage/prisma/schema.prisma lands.
 */
export function mapAwardToCompetitorActivity(
  ...
  return {
    ...
    startDate: raw["Start Date"] ? new Date(raw["Start Date"]) : null,
